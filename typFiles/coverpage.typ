...
#let coverpage( // Cover page function definition
  ...
  set page( // Background on full page
      ...
      background: image(coverIMG,height: 100%)
      )
  ...
  move(
    ...
    rect(
      ...
      [
        #set align(left)
        #text(fill: white, size: 24.88pt, font: "Bookman")[#title] // Thesis title
  
        #place( 
          dy: -15pt,
          text(fill: white, size: 14.4pt, font: "Bookman")[#subtitle] // Thesis Subtitle
        ) 
  
        #set align(bottom)
        #text(fill: cyan, size: 24.88pt, font: "Bookman")[#studentName] // Student Name
      ]
    )
  )
    ...
    rotate(
      ...
      rect(
        ...
        place(dx: 0.05/2*cu,dy: (21cm-1*cu)/2-0.05*cu, // Place text before rotation
          text(fill: white, size: 14.4pt, font: "Fira Sans",)[Literature Survey] 
        )
      ) 
    )
  )
